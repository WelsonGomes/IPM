...
begin
  ...
  if edt1.Text = '' then begin
    ShowMessage('É obrigatório informar o tamanho da matriz');
  end else begin
  ...
  mmo1.Lines.Add('');
  mmo1.Lines.Add('O menor elemento da matriz é '+ IntToStr(iMenor));
  mmo1.Lines.Add('O menor elemento da matriz está na posição: LINHA '+ IntToStr(iPosLin) + ' COLUNA '+ IntToStr(iPosCol));
end;
